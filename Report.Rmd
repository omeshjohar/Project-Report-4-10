...
#library(caTools)
#img <- read.gif ( "C://Users//omesh//Dropbox//Omesh-CC//eye-tracker//stimuli//images//1.gif")


#### Trying to check overlapping
### Read the data file
#a <- read.delim ( "C://Users//omesh//Dropbox//Omesh-CC//eye-tracker//data//zstat1//P03.txt", skip=9, header= TRUE, sep = '\t')
...
g <- ggplot ( a , aes ( x = Location.X, y = Location.Y ) ) +
 ...
 geom_point( colour = "red") + 
  ggtitle ("Fixations superimposed on the Graphs")
...
#for (j in 1:max(a$Number)) 
 # {
  #plot(x=a$Location.X[j], y=a$Location.Y[j], xlim = c(1,1300), ylim = r)
  #Sys.sleep(.2)
  #}
