...
# Get column names for fixation data (from line 9)
...
#df2 <- cbind ( id, v , df1 [,2:dim(df2)[2]])
...
g <- ggplot (data =df2 , aes ( x = Location.X, y = -Location.Y ) ) +
  ...
  geom_point ( data = df2[df2$Number ==1,], aes ( x = Location.X , y = -Location.Y), size = 3 , colour = 'green' )+
